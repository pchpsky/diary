defmodule DiaryWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use DiaryWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user) do
    token = Diary.Accounts.generate_user_session_token(user)
